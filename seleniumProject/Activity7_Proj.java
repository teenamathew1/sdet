...
public class Activity7_Proj {
    ...
    public void testmain() throws InterruptedException
    {
    	//Check the title of the page
    			...
    			WebElement additionalinfo = driver.findElement(By.xpath("//table[contains(@class,'table-responsive')]/tbody/tr[1]/td[10]/span/span[contains(@title,'Additional')]"));
    			
    			wait1.until(ExpectedConditions.visibilityOf(additionalinfo));
