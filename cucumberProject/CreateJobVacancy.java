...
public class CreateJobVacancy {
    ...
    public void AddVacancies() {
    	...
    	driver.findElement(By.id("addJobVacancy_name")).sendKeys("Vacancy_Project_CRM_5");
    ...
    public void VerifyVacancies() {
    	...
    	dropdown2.selectByVisibleText("Vacancy_Project_CRM_5");
    	...
    	String JobTitle1 = driver.findElement(By.linkText("Vacancy_Project_CRM_5")).getText();

    	Assert.assertEquals(JobTitle1, "Vacancy_Project_CRM_5");  	    
