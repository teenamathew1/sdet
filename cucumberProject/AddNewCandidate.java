...
public class AddNewCandidate {
    ...
    public void CandidateInformation() {
    	...
    	driver.findElement(By.id("addCandidate_firstName")).sendKeys("Soha");

    	driver.findElement(By.id("addCandidate_lastName")).sendKeys("Soha");

    	driver.findElement(By.id("addCandidate_email")).sendKeys("Example1293@test.com");
    	...
    	dropdown.selectByVisibleText("Automation Test Engineer1");
    ...
    public void Verfication() {	
    	...
    	dropdown1.selectByVisibleText("Automation Test Engineer1");
    	...
    	Name.sendKeys("Soha Soha");

    	driver.findElement(By.id("btnSrch")).click();    	    	

    	String JobTitle1 = driver.findElement(By.linkText("Soha Soha")).getText();

    	Assert.assertEquals(JobTitle1, "Soha Soha"); 
